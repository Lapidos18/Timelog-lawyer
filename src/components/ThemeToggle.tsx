 ...
 *
 * Светлая тема с 21.09.2026 — «Кабинет»: слоновая кость, тёмно-зелёный,
 * антиква в заголовках. Прежняя светлая «в стиле Google Диска» сохранена
 * в design/archive/light-theme-google-drive.css.
 *
