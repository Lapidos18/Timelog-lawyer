 ...
 * и тёмно-зелёный, тёмная — почти чёрный зелёный с латунью; шрифты общие.
 * Прежние темы сохранены в design/archive/ (светлая «в стиле Google Диска»
 * и тёмно-синяя с золотом) и отметками theme-light-google-drive /
 * theme-dark-navy в истории.
 *
